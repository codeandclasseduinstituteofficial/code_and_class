        ...
        <div className="min-h-screen bg-white py-16 px-4 sm:px-6 md:px-10 lg:px-20 relative top-16">
            ...
            <div className="text-center mb-10 max-w-2xl mx-auto">
                ...
                <p className="section-subheading">
                    Learn anytime, anywhere with our expert-led online courses designed to build practical skills and boost your career opportunities.
                </p>
            </div>
            ...
            {loading ? (
                ...
                <div className="text-center py-20">
                    <p className="text-slate-400 text-lg">
                        {search
                            ? `No online courses found for "${search}"`
                            : "No online courses available yet. Check back soon!"}
                    </p>
                </div>
            ) : (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                    <Fade direction="up" triggerOnce cascade damping={0.05}>
                        {filteredCourses
                            ?.filter((course) =>
                                course?.courseType === "only-online" ||
                                course?.courseType === "online-offline"
                            )
                            .map((course) => (
                                <CourseCard
                                    key={course?._id}
...
export default ExploreOnlineCourses;